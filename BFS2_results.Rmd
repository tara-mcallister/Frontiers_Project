...
BL_variability <- data.frame(subject = Children, baseline_stability = (bl1_sd/bl1_m)*100)
BL_stable <- subset(BL_variability, BL_variability$baseline_stability < 10)
BL_stable$subject
