...
#head(phasedata)
p1 <- qplot(data=phasedata, x=Type, y=ES, geom="boxplot")
...
p2 <- qplot(data=orderdata, x=tx_Order, y=ES, geom="boxplot")
#boxplot(phasedata$order_effect)

both <- gather(ESdata, tx_Order, ES, c(ESPhase1, ESPhase2))
#head(phasedata)

p3 <- qplot(data=phasedata, x=tx_order, y=ES, fill=Type, geom="boxplot")
#boxplot(phasedata$order_effect)
