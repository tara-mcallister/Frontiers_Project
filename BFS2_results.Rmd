...
phasedata$Condition <- mapvalues(phasedata$Type, from = c("ES_TRAD", "ES_BF"), 
                          to = c("Traditional", "Biofeedback")) 
...
p1 <- qplot(data=phasedata, x=Condition, y=ES, fill = Condition, geom="boxplot",
            ...
            labs(x = "Treatment Type", y = "Effect Size")
...
orderdata$Order <- mapvalues(orderdata$tx_Order, from = c("ESPhase1", "ESPhase2"), 
...
p2 <- qplot(data=orderdata, x=tx_Order_plot, y=ES, fill= tx_Order_plot, geom="boxplot", 
            ...
            scale_fill_manual(values = c("lightcoral", "cyan3")) + 
            labs(x = "Treatment Order", y = "Effect Size")
...
p3 <- qplot(data = phasedata, x = tx_order_plot, y = ES, fill = Condition, geom = "boxplot",
            main = "Effect Sizes by Condition and Treatment Order", xlab = "Treatment Order", ylab = "Effect Size")
...
#############################################################
#REMAINING TEXT IS IN BFS2_discussion.Rmd
```
